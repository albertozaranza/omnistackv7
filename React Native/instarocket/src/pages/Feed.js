...
export default class Feed extends Component {
  static navigationOptions = ({ navigation }) => ({
    headerRight: (
      <TouchableOpacity onPress={() => { navigation.navigate('New') }} style={{ marginHorizontal: 10 }}>
          ...
          renderItem={({ item }) => (
            <View style={styles.feedItem}>
              ...
              <View style={styles.feedItemHeader}>
                ...
                <Image source={more} style={{ height: 20, width: 20 }} />
              </View>

              <Image resizeMode={'contain'} style={styles.feedImage} source={{ uri: `http://10.0.0.106:3001/files/${item.image}` }} />
